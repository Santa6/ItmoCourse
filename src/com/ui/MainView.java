...
import com.app.security.ViewAccessControl;
...
public class MainView extends MainViewDesign implements ViewDisplay {
    ...
    @PostConstruct
    public void init() {
        attachNavigation(management, DragonView.class);
//        attachNavigation(logout, MainView.class);
        attachNavigation(login, LoginView.class);
